...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        positionsOfLivingGhosts = [belief.argMax() for belief in
            livingGhostPositionDistributions]
        _, nearestGhostPos = min([(self.distancer.getDistance(pacmanPosition,
          pos), pos) for pos in positionsOfLivingGhosts])
        _, best_action = min([(self.distancer.getDistance(nearestGhostPos,
          Actions.getSuccessor(pacmanPosition, a)), a) for a in legal])
        return best_action
        #get expected position with distribution.argMax()
