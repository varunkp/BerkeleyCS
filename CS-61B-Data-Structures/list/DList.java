...
public class DList {
    ...
    public void insertFront(Object item) { 
        DListNode theNext = head.next;
        DListNode theNewNode = newNode(item, this, head, theNext);
        head.next = theNewNode;
        theNext.prev = theNewNode;
        size++;
    }
    ...
    public void insertBack(Object item) {
        DListNode thePrev = head.prev;
        DListNode theNewNode = newNode(item, this, thePrev, head);
        head.prev = theNewNode;
        thePrev.next = theNewNode;
        size++;
    }
